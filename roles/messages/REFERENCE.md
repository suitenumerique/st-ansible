...
| st_messages_sdnotify | The sdnotify mode to use. The healthchecks have been removed temporarily, remove this when the healthchecks are back. | str | no | container |
