...
| st_meet_tag | Tag of the meet docker image to deploy. | str | no | v1.21.0 |
...
| st_meet_livekit_egress_image | Image repository for livekit egress. | str | no | docker.io/livekit/egress |
| st_meet_livekit_valkey_image | Image repository for the livekit valkey. | str | no | docker.io/valkey/valkey |
| st_meet_livekit_tag | Tag of the livekit docker image to deploy. | str | no | v1.13.2 |
| st_meet_livekit_egress_tag | Tag of the livekit egress docker image to deploy. | str | no | v1.13.0 |
